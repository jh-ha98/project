...
<%@ page contentType="text/html; charset=UTF-8"%>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">회원 포인트 관리</li>
                                    </ol> 
                                </nav>
                            </div>
                        </div>
                ...
                <h3>증감 포인트 : <input type="number" id="point" name="point"> <input type="submit" class="btn btn-primary" value="적용"></h3>
                                      ...
                                      <tr>
                                              ...
                                              <td>
                                              	<c:choose>
                                              		...
                                              		<c:when test="${dto.grade eq 'S'}">슈퍼 등급<span style="display:none">super</span>  </c:when>
                                              		<c:when test="${dto.grade eq 'U'}">일반 유저<span style="display:none">user</span>  </c:when>
                                              		<c:when test="${dto.grade eq 'D'}">휴먼 계정<span style="display:none">human Dormant</span> </c:when>
                                              		<c:when test="${dto.grade eq 'W'}">탈퇴 계정<span style="display:none">del Withdrawal</span>  </c:when>
		    		  							</c:choose>
                                              </td>
                                          </tr>
                                      </c:forEach>
