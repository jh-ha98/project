        ...
        <div class="row">
            <div class="col-md-12 ">
                <div class="error-text">
                    ...
                    <h4 class="font1">죄송합니다. 서비스 이용이 원활하지 않습니다.</h4>
                    <p class="font3">서비스 이용에 불편을 끼쳐 드려 죄송합니다.<br>잠시 후 해당 서비스를 이용해주시기 바랍니다.</p>
                    <a href="http://cartertrace2.cafe24.com/index.jsp" class="btn btn-primary btn-round font3">돌아가기</a>
                </div>
            </div>
        </div>
    </div>
