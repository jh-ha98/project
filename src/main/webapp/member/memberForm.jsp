...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">로그인</h2>
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="login.do" class="breadcrumb-link">로그인</a></li>
            ...
            <h4 class="mb-3 text-left"><strong>회원정보</strong></h4>
                ...
                <div class="form-group text-left">
                    <div class="input-group">
                        ...
                        <input type="file" class="form-control" name="pro_name" id="pro_name"  accept=".gif, .png, .jpg" size="15" required>
                    </div>
                </div>
                ...
                <div class="form-group text-left">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" name="pw" id="pw" size="15" >
                ...
                <div class="form-group text-left">
                    <div class="input-group">
                        ...
                        <input type="password" class="form-control" name="pw2" id="pw2" size="15" >
                    </div>
                </div>
                ...
                <div class="form-group text-left font1">
                    <div class="input-group" id="name_check">
                        ...
                        <input type="text" class="form-control" name="mem_name" id="mem_name" size="15" >
                    </div>
                </div>
				...
				<div class="form-group text-left font1">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control phone-inputmask" name="contact_number" id="contact_number" size="15">
                    </div>
                </div>
