...
//---------------------------------------
  ...
  public RentalDTO(String product_no, String product_name, String title, String sub_title, String description,
      int price_daily, int deposit, int total_quantity, int remaining_quantity, String thmb_name,
      String image_name, String reg_date, String id, String category_code, char availability) {
